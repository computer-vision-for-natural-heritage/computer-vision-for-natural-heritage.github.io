...
<div class="bg-body-tertiary text-body-primary rounded p-4 p-md-5 mb-4">
...
<div class="logo-item">
  <img class="logo-img" src="/assets/images/dtu_logo.png" alt="DTU logo" loading="lazy">
</div>

<!-- Logo 2: Mid-century modern style (using placeholder with brand feel) -->
<div class="logo-item">
  <img class="logo-img" src="/assets/images/ku_logo.png" alt="KU logo" loading="lazy">
</div>
